...
import { ArrowRight, ChevronRight, Lock, HeartCrack, FileText, History } from 'lucide-react';
      ...
      <nav className="fixed top-0 left-0 w-full z-50 h-20 bg-[#fafafa]/80 backdrop-blur-md border-b border-teal-52/10 shadow-[0_4px_20px_-10px_rgba(47,176,161,0.1)]">
        <div className="relative max-w-7xl mx-auto h-full flex items-center justify-between px-6 lg:px-16">
          ...
          <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center gap-8">
            <a href="#constat" className="font-sans text-teal-82 font-medium hover:text-[#2fb0a1] transition-colors">{t('nav.constat')}</a>
            <a href="#fonctionnement" className="font-sans text-teal-82 font-medium hover:text-[#2fb0a1] transition-colors">{t('nav.fonctionnement')}</a>
            <a href="#mise-en-place" className="font-sans text-teal-82 font-medium hover:text-[#2fb0a1] transition-colors">{t('nav.mise_en_place')}</a>
            <a href="#blog" className="font-sans text-teal-82 font-medium hover:text-[#2fb0a1] transition-colors">{t('nav.blog')}</a>
            <a href="#faq" className="font-sans text-teal-82 font-medium hover:text-[#2fb0a1] transition-colors">{t('nav.faq')}</a>
          </div>

          <div className="flex items-center gap-2 z-10">
            <LanguageSelector />
            <CtaLink href="/contact" ctaLabel={t('nav.cta')} eventPosition="navbar" className="px-5 sm:px-6 py-2 sm:py-2.5 rounded-xl bg-teal-52 text-white font-sans font-bold hover:bg-teal-82 transition-all hover:opacity-90 shadow-md shadow-teal-52/20 text-[14px]">
              {t('nav.cta')}
            </CtaLink>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 p-0 py-12 lg:p-16 flex flex-col justify-center items-start space-y-8 z-10">
          ...
          <div className="flex flex-col space-y-4 w-full">
            ...
            <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
              <CtaLink href="/contact" ctaLabel={t('hero.cta_primary')} eventPosition="hero" className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-teal-52 text-white font-bold transition-all hover:opacity-90 shadow-lg shadow-teal-52/30">
                {t('hero.cta_primary')} <ArrowRight className="w-5 h-5 opacity-90" />
              </CtaLink>
              <button className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl border border-transparent text-teal-52 font-bold transition-all hover:bg-teal-5">
                {t('hero.cta_secondary')} <ChevronRight className="w-5 h-5 opacity-90" />
              </button>
            </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 w-full bg-[#fafafa] rounded-3xl overflow-hidden shadow-none border-2 border-gray-100 divide-y-2 md:divide-y-0 md:divide-x-2 divide-gray-100">
            ...
            <div className="flex flex-col items-start p-6 lg:p-8 h-full">
              ...
              <div className="pr-6 lg:pr-12 xl:pr-16">
                <h3 className="font-serif font-semibold text-[22px] text-[#011a17] mb-3 leading-snug">
                  {t('constat.card2.title')}
                </h3>
                <p className="font-sans text-[15px] lg:text-[16px] text-[#1b544b] leading-relaxed">
                  {t('constat.card2.text')}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-start p-6 lg:p-8 h-full">
              ...
              <div className="pr-6 lg:pr-12 xl:pr-16">
                <h3 className="font-serif font-semibold text-[22px] text-[#011a17] mb-3 leading-snug">
                  {t('constat.card3.title')}
                </h3>
                <p className="font-sans text-[15px] lg:text-[16px] text-[#1b544b] leading-relaxed">
                  {t('constat.card3.text')}
                </p>
              </div>
            </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 flex flex-col items-center">
          ...
          <div className="flex flex-col w-full gap-24 lg:gap-32">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="w-full lg:w-1/2 flex flex-col space-y-6">
                <h3 className="font-serif font-bold text-[28px] lg:text-[32px] text-[#011a17] leading-snug">
                  {t('fonctionnement.patient.title')}
                </h3>
                <p className="font-sans text-[17px] lg:text-[18px] text-[#1b544b] leading-relaxed">
                  {t('fonctionnement.patient.text')}
                </p>
                <ul className="space-y-4 pt-4">
                  {ta<string[]>('fonctionnement.patient.features').map((item, i) => (
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
              ...
              <div className="w-full lg:w-1/2 flex flex-col space-y-6">
                <h3 className="font-serif font-bold text-[28px] lg:text-[32px] text-[#011a17] leading-snug">
                  {t('fonctionnement.therapist.title')}
                </h3>
                <p className="font-sans text-[17px] lg:text-[18px] text-[#1b544b] leading-relaxed">
                  {t('fonctionnement.therapist.text')}
                </p>
                <ul className="space-y-4 pt-4">
                  {ta<string[]>('fonctionnement.therapist.features').map((item, i) => (
                    <li key={i} className="flex items-start gap-4">
                      <div className="w-6 h-6 rounded-full bg-[#e5fbf7] flex items-center justify-center shrink-0 mt-0.5">
                        <svg className="w-4 h-4 text-[#2fb0a1]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  ...
                  <div className="flex-1 flex gap-6">
                    ...
                    <div className="w-2/3 flex flex-col space-y-4">
                      ...
                      <div className="w-full h-20 bg-[#fafafa] rounded-xl border border-gray-100 flex items-center px-4">
                        ...
                        <div className="ml-auto px-3 py-1 rounded-full bg-[#e5fbf7] flex items-center justify-center text-[10px] text-[#2fb0a1] font-bold">{t('fonctionnement.dashboard_badge')}</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12 flex flex-col items-center">
          ...
          <div className="flex flex-col items-center text-center max-w-2xl mb-12 lg:mb-16 space-y-3">
            <span className="font-sans font-bold text-[#2c9d8f] uppercase tracking-widest text-sm">
              {t('mise_en_place.label')}
            </span>
            <h2 className="font-serif font-bold text-3xl lg:text-[40px] text-[#011a17] leading-tight">
              {t('mise_en_place.title')}
            </h2>
          </div>
            ...
            <div className="w-full flex justify-center relative h-full min-h-[450px]">
              <div className="relative w-full h-full min-h-[450px]">
                ...
                <div className="absolute -bottom-6 -right-2 lg:-bottom-8 lg:-right-8 bg-[#fafafa] p-4 lg:p-5 rounded-2xl shadow-[0_8px_30px_-4px_rgba(0,0,0,0.08)] border border-gray-100 flex items-center gap-4 z-20">
                  ...
                  <div>
                    <p className="font-sans font-bold text-[15px] text-[#011a17] leading-snug">{t('mise_en_place.floating.title')}</p>
                    <p className="font-sans text-[13px] text-[#1b544b] opacity-80">{t('mise_en_place.floating.subtitle')}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
            ...
            <div className="flex flex-col space-y-6">
              <h4 className="font-sans font-semibold text-[#fafafa]">{t('footer.product.title')}</h4>
              <ul className="flex flex-col space-y-3">
                <li><a href="#constat" className="font-sans text-[15px] text-[#fafafa]/70 hover:text-[#2fb0a1] transition-colors">{t('footer.product.constat')}</a></li>
                <li><a href="#fonctionnement" className="font-sans text-[15px] text-[#fafafa]/70 hover:text-[#2fb0a1] transition-colors">{t('footer.product.fonctionnement')}</a></li>
                <li><a href="#mise-en-place" className="font-sans text-[15px] text-[#fafafa]/70 hover:text-[#2fb0a1] transition-colors">{t('footer.product.mise_en_place')}</a></li>
                <li><a href="#faq" className="font-sans text-[15px] text-[#fafafa]/70 hover:text-[#2fb0a1] transition-colors">{t('footer.product.faq')}</a></li>
              </ul>
            </div>

            {/* Colonne 3 : Ressources */}
            <div className="flex flex-col space-y-6">
              <h4 className="font-sans font-semibold text-[#fafafa]">{t('footer.resources.title')}</h4>
              <ul className="flex flex-col space-y-3">
                <li><a href="#blog" className="font-sans text-[15px] text-[#fafafa]/70 hover:text-[#2fb0a1] transition-colors">{t('footer.resources.blog')}</a></li>
                <li><a href="#" className="font-sans text-[15px] text-[#fafafa]/70 hover:text-[#2fb0a1] transition-colors">{t('footer.resources.practitioner')}</a></li>
                <li><a href="#" className="font-sans text-[15px] text-[#fafafa]/70 hover:text-[#2fb0a1] transition-colors">{t('footer.resources.waitlist')}</a></li>
              </ul>
            </div>

            {/* Colonne 4 : Légal */}
            <div className="flex flex-col space-y-6">
              <h4 className="font-sans font-semibold text-[#fafafa]">{t('footer.legal.title')}</h4>
              <ul className="flex flex-col space-y-3">
                <li><a href="#" className="font-sans text-[15px] text-[#fafafa]/70 hover:text-[#2fb0a1] transition-colors">{t('footer.legal.mentions')}</a></li>
                <li><a href="#" className="font-sans text-[15px] text-[#fafafa]/70 hover:text-[#2fb0a1] transition-colors">{t('footer.legal.privacy')}</a></li>
                <li><a href="#" className="font-sans text-[15px] text-[#fafafa]/70 hover:text-[#2fb0a1] transition-colors">{t('footer.legal.cgu')}</a></li>
              </ul>
            </div>
